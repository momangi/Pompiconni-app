              ...
              <Card key={illustration.id} className="border-2 border-green-100 hover-lift">
                <CardContent className="p-4">
                  ...
                  <Button 
                    ...
                    onClick={() => handleDownload(illustration, 'single')}
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              Bundle & <span className="gradient-text">Pacchetti</span>
            </h2>
            <p className="text-gray-600 max-w-xl mx-auto">
              Risparmia con i nostri pacchetti completi! PDF pronti per la stampa in formato A4.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {bundles.map((bundle, idx) => (
              <Card 
                key={bundle.id} 
                className={`border-2 hover-lift relative overflow-hidden ${
              ...
              >
                ...
                <CardHeader className="text-center pb-2">
                  <div className={`w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-2 ${
                    bundle.isFree ? 'bg-green-100' : 'bg-pink-100'
                  }`}>
                    <Package className={`w-8 h-8 ${
                      bundle.isFree ? 'text-green-500' : 'text-pink-500'
                    }`} />
                  </div>
                ...
                <CardContent className="text-center">
                  ...
                  <ul className="text-sm text-gray-600 mb-6 space-y-2">
                    <li className="flex items-center justify-center gap-2">
                      ...
                      {bundle.illustrationCount} illustrazioni
                    </li>
                    <li className="flex items-center justify-center gap-2">
                      <Check className="w-4 h-4 text-green-500" />
                      Formato PDF A4
                  ...
                  <Button 
                    ...
                    onClick={() => handleDownload(bundle, 'bundle')}
                  >
                    <Download className="w-4 h-4 mr-2" />
                    {bundle.isFree ? 'Scarica Gratis' : 'Acquista Ora'}
                  </Button>
                </CardContent>
              </Card>
            ))}
