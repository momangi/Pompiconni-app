    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Heart, title: 'Dolce', desc: 'Con i suoi occhi grandi e le guanciotte rosate, Pompiconni conquista tutti con la sua dolcezza', color: 'pink' },
              { icon: Sparkles, title: 'Simpatico', desc: 'Sempre pronto a far sorridere con le sue espressioni buffe e le sue avventure divertenti', color: 'blue' },
              { icon: Star, title: 'Impacciato', desc: 'Un po\' goffo ma adorabile, si caccia sempre in situazioni comiche ma trova sempre la soluzione', color: 'yellow' }
            ].map((item, idx) => (
              <Card key={idx} className="border-0 shadow-lg hover-lift bg-gradient-to-b from-white to-gray-50">
                <CardContent className="p-8 text-center">
                  <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-${item.color}-100 flex items-center justify-center`}>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Scarica le tavole gratuite o scegli un pacchetto completo!
            </p>
          </div>
          
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {bundles.map((bundle) => (
              <Card key={bundle.id} className={`border-2 hover-lift ${
                bundle.isFree ? 'border-green-200 bg-green-50/30' : 'border-pink-200'
              }`}>
      ...
      <section className="py-20 bg-gradient-to-b from-pink-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">
              Cosa dicono di <span className="gradient-text">Pompiconni</span>
            </h2>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-pink-100 via-blue-50 to-green-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-6">
            Pronto a colorare con Pompiconni?
          </h2>
          <p className="text-lg text-gray-600 mb-8">
            Scarica subito le tavole gratuite e inizia la tua avventura!
          </p>
          <Link to="/download">
