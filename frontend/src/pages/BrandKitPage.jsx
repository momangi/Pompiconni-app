        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-800 mb-4">
              Brand Kit <span className="gradient-text">Pompiconni</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Linee guida per mantenere coerenza visiva in tutte le illustrazioni e materiali
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="flex justify-center">
                  <div className="relative">
                    ...
                    {/* Annotation */}
                    <div className="absolute -right-4 top-10 bg-white px-3 py-2 rounded-lg shadow-lg text-sm">
                      <p className="font-semibold text-pink-500">Occhi grandi</p>
                    </div>
                    <div className="absolute -left-4 top-1/3 bg-white px-3 py-2 rounded-lg shadow-lg text-sm">
                      <p className="font-semibold text-blue-500">Corno arcobaleno</p>
                    </div>
                    <div className="absolute -right-4 bottom-20 bg-white px-3 py-2 rounded-lg shadow-lg text-sm">
                      <p className="font-semibold text-green-500">Guanciotte rosate</p>
                    </div>
                  </div>
                </div>
                    ...
                    <CardContent>
                      <div className="mb-6">
                        <p className="text-lg text-gray-600 italic">
                          "{brandKit.character.personality}"
                        </p>
                      </div>
            ...
            <TabsContent value="style">
              <div className="max-w-4xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <CardContent>
                      <div className="space-y-6">
                        <div>
                          ...
                          <p className="text-3xl font-bold" style={{ fontFamily: 'Quicksand' }}>
                            {brandKit.typography.primary}
                          </p>
                          <p className="text-gray-600 mt-1">Per titoli e intestazioni</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500 mb-2">Font Secondario</p>
                          <p className="text-2xl" style={{ fontFamily: 'Nunito' }}>
                            {brandKit.typography.secondary}
                          </p>
                          <p className="text-gray-600 mt-1">Per testi e paragrafi</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg p-4">
                          <p className="text-sm text-gray-600">
                            <strong>Stile:</strong> {brandKit.typography.style}
                          </p>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card className="border-0 shadow-lg">
                    <CardHeader>
                      <CardTitle>Linee Guida Illustrazioni</CardTitle>
                    </CardHeader>
                    <CardContent>
