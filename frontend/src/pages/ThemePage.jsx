        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <Badge variant="secondary" className="px-4 py-2 text-base">{themeIllustrations.length} tavole</Badge>
              ...
              <Card key={illustration.id} className="border-0 shadow-lg hover-lift overflow-hidden group">
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                    <Dialog>
                      ...
                      <DialogContent className="sm:max-w-lg">
                        ...
                        <div className="mt-4">
                          <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center mb-4"><div className="text-8xl opacity-40">🦄</div></div>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    {!illustration.isFree && <span className="text-pink-500 font-semibold">€0.99</span>}
                  </div>
                </CardContent>
              </Card>
            ))}
